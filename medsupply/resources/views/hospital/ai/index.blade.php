...
<div class="ai-wrap">
  ...
  <div class="side-panel">
    <div class="side-card">
      ...
      <button class="suggestion-btn" onclick="useSuggestion(this)">Comment gérer une commande urgente ?</button>
      <button class="suggestion-btn" onclick="useSuggestion(this)">Comment vérifier mon stock critique ?</button>
      <button class="suggestion-btn" onclick="useSuggestion(this)">Comment évaluer un fournisseur médical ?</button>
      <button class="suggestion-btn" onclick="useSuggestion(this)">Procédure de commande standard</button>
    ...
    <div class="side-card">
      ...
      <div style="font-size:0.76rem;color:var(--text3);line-height:1.5;">
        MedBot est spécialisé dans la gestion médicale et répond en français.
      </div>
    </div>
  </div>
</div>
...
async function sendMessage() {
    ...
    try {
        const response = await fetch('{{ route("hospital.ai.chat") }}', {
            method: 'POST',
            headers: {
